				...
				$('#btn_pesquisar').click(function(){
					...
					if($('#txt_nome').val().length > 0){
						...
						$.ajax({
							...
							url: 'get_pessoas.php',
							method: "post",
							data: $('#form_procurar_pessoas').serialize(), // Serialize coloca tudo em uma estrutura JSON
	    			...
	    			<div class="panel-body">
	    				...
	    				<form id="form_procurar_pessoas">
		    				<div class="input-group">
		    					...
		    					<button id="btn_pesquisar" class="btn btn-default" type="button">Pesquisar</button>
		    					</span>
	    					</div>
	    				</form>
	    			</div>
