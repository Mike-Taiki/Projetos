...
$sql = mysqli_query($conexao, " SELECT u.*, us.id_usuario_seguidor FROM usuarios AS u LEFT JOIN usuarios_seguidores AS us ON (u.id = us.seguindo_id_usuario AND us.id_usuario = $id_usuario) WHERE u.usuario like '%$nome%' AND u.id <> $id_usuario ");
